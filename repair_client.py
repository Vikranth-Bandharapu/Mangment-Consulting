...
with open('dashboard_client.html', 'r', encoding='utf-8') as f:
    content = f.read()

idx = content.find('<div style="position: relative;">\n    navItems.forEach(item => {')
if idx == -1:
    idx = content.find('DevOps Team - Yesterday</p>\n                </div>\n                <div style="position: relative;">\n    navItems.forEach')

if idx != -1:
    cut_point = content.find('<div style="position: relative;">', idx)
    content = content[:cut_point]
else:
    print("Could not find the cut point.")

rest_of_file = """                <div style="position: relative;">
